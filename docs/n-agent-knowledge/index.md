---
okf_version: "0.1"
title: N-Agent Knowledge Bundle
description: Project-specific context bundle for task understanding, evidence, and planning.
---

# N-Agent Knowledge Bundle

This bundle adapts the useful parts of Knowledge Catalog and OKF for N-Agent.
...
* [Context Pack Governance](concepts/context-pack-governance.md) - How N-Agent selects local context and keeps it bounded.
